  ...
  return (
    <section className="py-20 md:py-32 px-4 md:px-6" style={{ backgroundColor: "#0A0A0A" }}>
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="text-3xl md:text-5xl font-bold mb-6 md:mb-8" style={{ color: "#F0EDE8" }}>
          Pronto para construir sua estrutura digital <span style={{ color: "#E5001B" }}>estratégica?</span>
        </h2>

        <p className="text-base md:text-lg leading-relaxed mb-10 md:mb-12" style={{ color: "rgba(240, 237, 232, 0.75)" }}>
